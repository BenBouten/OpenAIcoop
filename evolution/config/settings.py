...
OCEAN_SURFACE_Y = 300  # Height of the air strip above the water
...
REPRODUCTION_INTENT_THRESHOLD = 0.6
GROWTH_MIN_SCALE = 0.3
MATURITY_FULL_SIZE = 100
...
_NUMERIC_BOUNDS: Dict[str, tuple[float, float]] = {
    ...
    "THRUST_BASE_MULTIPLIER": (0.1, 50.0),
    "DRAG_COEFFICIENT_MULTIPLIER": (0.01, 5.0),
    "MIN_MATURITY": (1, 200),
    "MAX_MATURITY": (1, 400),
    "VISION_MIN": (1, 1000),
    "VISION_MAX": (1, 2000),
...
def apply_runtime_settings(new_settings: SimulationSettings) -> SimulationSettings:
    ...
    global MODULE_SPRITE_SCALE, MODULE_SPRITE_MIN_PX, MODULE_SPRITE_MIN_LENGTH, MODULE_SPRITE_MIN_HEIGHT
    global THRUST_SCALE_EXPONENT, THRUST_BASE_MULTIPLIER
    global DRAG_COEFFICIENT_MULTIPLIER
