...
class Vegetation:
    """Organic moss patch that acts as a slow-growing food source."""
    ...
    def set_size(self) -> None:
        # Width/height are kept for backward compatibility with legacy code.
...
def init_vegetation():
    ...
    for _ in range(settings.N_VEGETATION):
        ...
        variant = random.choices(
            ["normal", "radiant", "spore", "fortified"], weights=weights
        )[0]
