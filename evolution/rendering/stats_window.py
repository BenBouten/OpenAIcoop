...
class StatsWindow:
    ...
    def _summary_lines(self) -> List[str]:
        ...
        lines = [
            ...
            f"Gem. fys. volume: {self._format_float(stats.get('average_body_volume', 0), 1)}",
            f"Gem. fys. dichtheid: {self._format_float(stats.get('average_body_density', 0), 2)}",
            f"Gem. fys. onderhoud: {self._format_float(stats.get('average_body_energy_cost', 0), 3)}",
            f"Gem. fys. vermogen: {self._format_float(stats.get('average_body_power_output', 0), 1)}",
            f"Gem. fys. grip: {self._format_float(stats.get('average_body_grip_strength', 0), 1)}",
